...
local aa = {
    ...
    [50] = function()
        ...
        return {
            ...
            AcrylicBorder = Color3.fromRGB(0, 204, 204),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(40, 40, 40), Color3.fromRGB(40, 40, 40)),
            AcrylicNoise = 0.9,
            TitleBarLine = Color3.fromRGB(0, 204, 204),
            Tab = Color3.fromRGB(0, 204, 204),
            Element = Color3.fromRGB(160, 160, 160),
            ElementBorder = Color3.fromRGB(35, 35, 35),
            InElementBorder = Color3.fromRGB(90, 90, 90),
            ElementTransparency = 0.87,
            ToggleSlider = Color3.fromRGB(255, 0, 0),
            ToggleToggled = Color3.fromRGB(0, 204, 204),
