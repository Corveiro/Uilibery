...
function Library:NewWindow(ConfigWindow)
    ...
    Main.Transparency = 1 -- Para animação de entrada
    ...
    UIStroke.Transparency = 1 -- Para animação de entrada

    Top.Name = "Top"
    Top.Parent = Main
    Top.BackgroundColor3 = Color3.fromRGB(20, 20, 30)
    Top.Size = UDim2.new(1, 0, 0, 40)
    Top.BackgroundTransparency = 1 -- Para animação de entrada
    ...
    LogoHub.ImageTransparency = 1 -- Para animação de entrada
    ...
    NameHub.TextTransparency = 1 -- Para animação de entrada
    ...
    Desc.TextTransparency = 1 -- Para animação de entrada
    ...
    Close.TextSize = 14
    Close.TextTransparency = 1 -- Para animação de entrada
    ...
    Minize.TextSize = 14
    Minize.TextTransparency = 1 -- Para animação de entrada
    ...
    TabHolder.BackgroundTransparency = 1 -- Para animação de entrada
    ...
    Close.MouseButton1Click:Connect(function() 
        ...
        TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Back, Enum.EasingDirection.In), {Size = UDim2.new(0, 0, 0, 0), Transparency = 1}):Play()
        task.wait(0.5)
        TeddyUI_Premium:Destroy() 
    end)
    Minize.MouseButton1Click:Connect(function() TeddyUI_Premium.Enabled = not TeddyUI_Premium.Enabled end)

    -- [ Arcade Intro Animation ] --
    local function PlayIntro()
        ...
        -- Efeito de "Power On" (Linha expandindo horizontalmente)
        local tween1 = TweenService:Create(Main, TweenInfo.new(0.4, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Size = UDim2.new(1, 0, 0, 2)})
        tween1:Play()
        tween1.Completed:Wait()
        
        -- Expansão vertical com efeito elástico
        local tween2 = TweenService:Create(Main, TweenInfo.new(0.6, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {Size = OriginalSize})
        tween2:Play()
        
        task.wait(0.2)
        TweenService:Create(Top, TweenInfo.new(0.3), {BackgroundTransparency = 0}):Play()
        TweenService:Create(TabHolder, TweenInfo.new(0.3), {BackgroundTransparency = 0}):Play()
        
        task.wait(0.1)
        TweenService:Create(LogoHub, TweenInfo.new(0.3), {ImageTransparency = 0}):Play()
        TweenService:Create(NameHub, TweenInfo.new(0.3), {TextTransparency = 0}):Play()
        TweenService:Create(Desc, TweenInfo.new(0.3), {TextTransparency = 0}):Play()
        TweenService:Create(Close, TweenInfo.new(0.3), {TextTransparency = 0}):Play()
        TweenService:Create(Minize, TweenInfo.new(0.3), {TextTransparency = 0}):Play()
    end
