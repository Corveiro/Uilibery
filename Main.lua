...
function Library:NewWindow(ConfigWindow)
    ...
    DropShadow.Size = UDim2.new(1, 55, 1, 55)
    ...
    MainGradient.Color = ColorSequence.new{
        ...
        ColorSequenceKeypoint.new(0.5, Color3.fromRGB(11, 11, 15)),
        ColorSequenceKeypoint.new(1, Color3.fromRGB(8, 8, 12))
    }
    MainGradient.Rotation = 135
    MainGradient.Parent = Main

    -- Premium glow effect for accent
    ...
    NameHub.TextStrokeTransparency = 0.85
    ...
    Desc.TextColor3 = Color3.fromRGB(175, 175, 190)
    Desc.TextSize = 13
    ...
    Minize.BackgroundColor3 = Color3.fromRGB(32, 32, 42)
    Minize.BackgroundTransparency = 0.3
    Minize.Size = UDim2.new(0, 32, 0, 32)
    Minize.Font = Enum.Font.GothamBold
    Minize.Text = "−"
    Minize.TextColor3 = Color3.fromRGB(220, 220, 235)
    Minize.TextSize = 18
    ...
    Close.BackgroundColor3 = Color3.fromRGB(235, 55, 75)
    ...
    local function AddButtonEffect(button, hoverColor, originalColor)
        ...
        button.MouseLeave:Connect(function()
            ...
            Library:TweenInstance(button, 0.2, "BackgroundTransparency", button.Name == "Minimize" and 0.3 or 0.1)
        end)
    end

    AddButtonEffect(Minize, Color3.fromRGB(48, 48, 62), Color3.fromRGB(32, 32, 42))
    AddButtonEffect(Close, Color3.fromRGB(255, 75, 95), Color3.fromRGB(235, 55, 75))
    ...
    function Tab:NewTab(ConfigTab)
        ...
        -- Enhanced glow background for active state
        TabGlow.Name = "Glow"
        ...
        TabIcon.ImageColor3 = Color3.fromRGB(170, 170, 185)
        ...
        local function SelectTab()
            for _, v in pairs(TabHolder:GetChildren()) do
                if v:IsA("TextButton") then
                    ...
                    Library:TweenInstance(v, 0.2, "BackgroundColor3", isSelected and Color3.fromRGB(28, 28, 38) or Color3.fromRGB(22, 22, 30))
                    Library:TweenInstance(v, 0.2, "BackgroundTransparency", isSelected and 0 or 0.4)
                    
                    local glow = v:FindFirstChild("Glow")
                    if glow then
                        Library:TweenInstance(glow, 0.2, "BackgroundTransparency", isSelected and 0.91 or 1)
                    end
                    
                    local icon = v:FindFirstChild("Icon")
                    if icon then
                        Library:TweenInstance(icon, 0.2, "ImageColor3", isSelected and ConfigWindow.AccentColor or Color3.fromRGB(170, 170, 185))
                    end
                    
                    local title = v:FindFirstChild("Title")
                    if title then
                        Library:TweenInstance(title, 0.2, "TextColor3", isSelected and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(200, 200, 210))
                    end
        ...
        TabButton.MouseEnter:Connect(function()
            if TabButton.BackgroundTransparency > 0.1 then
                Library:TweenInstance(TabButton, 0.2, "BackgroundTransparency", 0.2)
            end
        end)
        
        TabButton.MouseLeave:Connect(function()
            if TabButton.BackgroundTransparency > 0.1 then
                Library:TweenInstance(TabButton, 0.2, "BackgroundTransparency", 0.4)
            end
        end)
        ...
        function TabFunc:NewSection(ConfigSection)
            ...
            SectionStroke.Color = Color3.fromRGB(45, 45, 60)
            SectionStroke.Thickness = 1.5
            SectionStroke.Transparency = 0.55
            ...
            SectionTitle.TextColor3 = Color3.fromRGB(245, 245, 255)
            ...
            SectionDivider.BackgroundTransparency = 0.55
            SectionDivider.Position = UDim2.new(0, 15, 0, 38)
            SectionDivider.Size = UDim2.new(1, -30, 0, 1.5)
    ...
    MainBtn.MouseEnter:Connect(function()
        Library:TweenInstance(MainBtn, 0.2, "Size", UDim2.new(0, 56, 0, 56))
        Library:TweenInstance(BtnGlow, 0.2, "ImageTransparency", 0.45)
        Library:TweenInstance(BtnStroke, 0.2, "Transparency", 0.75)
    end)

    MainBtn.MouseLeave:Connect(function()
        Library:TweenInstance(MainBtn, 0.2, "Size", UDim2.new(0, 52, 0, 52))
        Library:TweenInstance(BtnGlow, 0.2, "ImageTransparency", 0.6)
        Library:TweenInstance(BtnStroke, 0.2, "Transparency", 0.88)
    end)
