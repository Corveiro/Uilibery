...
function Library:NewWindow(ConfigWindow)
	...
	Line.BackgroundColor3 = Color3.fromRGB(255,60,120)
	...
	NameHub.TextColor3 = Color3.fromRGB(235,235,235)
	...
	LogoHub.BackgroundColor3 = Color3.fromRGB(255,60,120)
	...
	Icon.BackgroundColor3 = Color3.fromRGB(255,60,120)
	...
	Icon_2.BackgroundColor3 = Color3.fromRGB(255,60,120)
	...
	Close.MouseButton1Down:Connect(function()
		...
		tat_["BorderColor3"] = Color3.fromRGB(255,60,120);
	...
	Icon_3.BackgroundColor3 = Color3.fromRGB(255,60,120)
	...
	UIStroke.Color = Color3.fromRGB(255,60,120)
	...
	Line_2.BackgroundColor3 = Color3.fromRGB(255,60,120)
	...
	IconSearch.BackgroundColor3 = Color3.fromRGB(255,60,120)
	...
	function Tab:T(t, iconid)
		...
		Choose_2.BackgroundColor3 = Color3.fromRGB(255,60,120)
		...
		IconRound.CornerRadius = UDim.new(0, 12)
		...
		NameTab_2.TextColor3 = Color3.fromRGB(235,235,235)
		...
		function TabFunc:AddSection(RealNameSection)
			...
			UIGradient.Color = ColorSequence.new { ColorSequenceKeypoint.new(0.00, Color3.fromRGB(24, 24, 25)), ColorSequenceKeypoint.new(0.52, Color3.fromRGB(255,60,120)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(24, 24, 25)) }
			...
			function SectionFunc:AddToggle(cftoggle)
				...
				Content.TextColor3 = Color3.fromRGB(160,160,170)
				...
				function ToggleFunc:Set(Boolean)
					...
					if Boolean then
						...
						Library:TweenInstance(ToggleCheck, 0.3, "BackgroundColor3", Color3.fromRGB(255,60,120))
			...
			function SectionFunc:AddButton(cfbutton)
				...
				Content_2.TextColor3 = Color3.fromRGB(160,160,170)
				...
				ImageLabel.BackgroundColor3 = Color3.fromRGB(255,60,120)
			...
			function SectionFunc:AddDropdown(cfdropdown)
				...
				Title_8.TextColor3 = Color3.fromRGB(235,235,235)
				...
				Content_6.TextColor3 = Color3.fromRGB(160,160,170)
				...
				Selects.BackgroundColor3 = Color3.fromRGB(18,18,22)
				...
				SelectText.TextColor3 = Color3.fromRGB(235,235,235)
				...
				Title_10.TextColor3 = Color3.fromRGB(235,235,235)
				...
				function DropFunc:Add(v)
					...
					Option2.BackgroundTransparency = 0.1
					...
					Title_12.TextColor3 = Color3.fromRGB(235,235,235)

					Title_12.TextSize = 13.000

					Title_12.TextTransparency = 0.500

					UIGradient_3.Color = ColorSequence.new { ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), ColorSequenceKeypoint.new(0.51, Color3.fromRGB(255,60,120)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0)) }
			...
			function SectionFunc:AddInput(cftextbox)
				...
				Content_5.TextColor3 = Color3.fromRGB(160,160,170)
				...
				RealTextBox.TextColor3 = Color3.fromRGB(235,235,235)
			...
			function SectionFunc:AddSlider(cfslider)
				...
				Content_3.TextColor3 = Color3.fromRGB(160,160,170)
				...
				SliderDraggable.BackgroundColor3 = Color3.fromRGB(255,60,120)
			...
			function SectionFunc:AddParagraph(cfpara)
				...
				Content_4.TextColor3 = Color3.fromRGB(160,160,170)
			...
			function SectionFunc:AddDiscord(DiscordTitle, InviteCode)
				...
				DiscordCard.BackgroundColor3 = Color3.fromRGB(18,18,22) -- Cor ajustada para combinar com o tema escuro
				...
				JoinBtn.Text = "Join"
				JoinBtn.TextColor3 = Color3.fromRGB(235,235,235)
				JoinBtn.TextSize = 13
