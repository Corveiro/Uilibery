...
local themes = {
    SchemeColor = Color3.fromRGB(180, 180, 195),
    Background = Color3.fromRGB(10, 10, 12),
    Header = Color3.fromRGB(15, 15, 18),
    TextColor = Color3.fromRGB(230, 230, 235),
    ElementColor = Color3.fromRGB(20, 20, 24)
}
local themeStyles = {
    DarkTheme = {
        SchemeColor = Color3.fromRGB(180, 180, 195),
...
function Kavo.CreateLib(kavName, themeList)
    ...
    MainHeader.Size = UDim2.new(0, 525, 0, 36)
    ...
    coverup.BackgroundColor3 = Color3.fromRGB(40, 40, 50)
    coverup.BorderSizePixel = 0
    coverup.Position = UDim2.new(0, 0, 0.80, 0)
    coverup.Size = UDim2.new(0, 525, 0, 1)
    ...
    MainSide.Size = UDim2.new(0, 145, 0, 289)
    ...
    coverup_2.BackgroundColor3 = Color3.fromRGB(35, 35, 45)
    coverup_2.BorderSizePixel = 0
    coverup_2.Position = UDim2.new(1, -1, 0, 0)
    coverup_2.Size = UDim2.new(0, 1, 0, 289)
    ...
    game.TweenService:Create(Main, TweenInfo.new(0.35, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
    ...
    function Tabs:NewTab(tabName)
        ...
        tabButton.MouseButton1Click:Connect(function()
            ...
            for i,v in next, tabFrames:GetChildren() do
                if v:IsA("TextButton") then
                    ...
                    game.TweenService:Create(v, TweenInfo.new(0.18, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundTransparency = 1, TextColor3 = Color3.fromRGB(100, 100, 115)}):Play()
                end
            end
            game.TweenService:Create(tabButton, TweenInfo.new(0.18, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundTransparency = 0, TextColor3 = Color3.fromRGB(235, 235, 240)}):Play()
        end)
        local Sections = {}
		...
		sectionHead.Visible = true
            ...
            sectionHead.BackgroundColor3 = Color3.fromRGB(18, 18, 22)
            sectionHead.Size = UDim2.new(0, 352, 0, 30)
        ...
        coroutine.wrap(function()
            ...
            function Elements:NewButton(bname,tipINf, callback)
                ...
                viewInfo.ImageColor3 = Color3.fromRGB(100, 100, 115)
                ...
                Sample.ImageColor3 = Color3.fromRGB(130, 130, 145)
                ...
                moreInfo.BackgroundColor3 = Color3.fromRGB(22, 22, 28)
                ...
                touch.ImageColor3 = Color3.fromRGB(160, 160, 175)
                ...
                btnInfo.TextColor3 = Color3.fromRGB(220, 220, 228)
                ...
                btn.MouseEnter:Connect(function()
                    if not focusing then
                        game.TweenService:Create(btn, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
                            BackgroundColor3 = Color3.fromRGB(themeList.ElementColor.r * 255 + 12, themeList.ElementColor.g * 255 + 12, themeList.ElementColor.b * 255 + 14)
                        }):Play()
                        hovering = true
                    end
                end)
            ...
            function Elements:NewTextBox(tname, tTip, callback)
                ...
                write.ImageColor3 = Color3.fromRGB(160, 160, 175)
                ...
                TextBox.Text = ""
                TextBox.TextColor3 = Color3.fromRGB(200, 200, 215)
                ...
                function Elements:NewToggle(tname, nTip, callback)
                    ...
                    toggleDisabled.ImageColor3 = Color3.fromRGB(160, 160, 175)
                    ...
                    toggleEnabled.ImageColor3 = Color3.fromRGB(160, 160, 175)
                    ...
                    togName.Text = tname
                    togName.RichText = true
                    togName.TextColor3 = Color3.fromRGB(220, 220, 228)
            ...
            function Elements:NewSlider(slidInf, slidTip, maxvalue, minvalue, callback)
                ...
                sliderBtn.BackgroundColor3 = Color3.fromRGB(30, 30, 36)
                sliderBtn.BorderSizePixel = 0
                sliderBtn.Position = UDim2.new(0.488749951, 0, 0.393939406, 0)
                sliderBtn.Size = UDim2.new(0, 149, 0, 5)
                ...
                sliderDrag.BackgroundColor3 = Color3.fromRGB(190, 190, 205)
                ...
                val.Text = minvalue
                val.TextColor3 = Color3.fromRGB(190, 190, 205)
                val.TextSize = 12.000
            ...
            function Elements:NewDropdown(dropname, dropinf, list, callback)
                ...
                listImg.ImageColor3 = Color3.fromRGB(160, 160, 175)
                ...
                for i,v in next, list do
                    ...
                    Sample1.ImageColor3 = Color3.fromRGB(130, 130, 145)
                    ...
                    coroutine.wrap(function()
                        while wait() do
                            ...
                            optionSelect.TextColor3 = Color3.fromRGB(200, 200, 210)
                            Sample1.ImageColor3 = Color3.fromRGB(130, 130, 145)
                        end
                    end)()
                end
                ...
                function DropFunction:Refresh(newList)
                    ...
                    for i,v in next, newList do
                        ...
                        Sample11.ImageColor3 = Color3.fromRGB(130, 130, 145)
            ...
            function Elements:NewKeybind(keytext, keyinf, first, callback)
                ...
                togName_2.TextColor3 = Color3.fromRGB(160, 160, 175)
            ...
            function Elements:NewColorPicker(colText, colInf, defcolor, callback)
                ...
                colorInners.BackgroundColor3 = Color3.fromRGB(16, 16, 20)
                ...
                togName_2.TextColor3 = Color3.fromRGB(200, 200, 210)
                togName_2.TextSize = 14.000
            ...
            function Elements:NewLabel(title)
            	...
            	label.BackgroundColor3 = Color3.fromRGB(22, 22, 28)
